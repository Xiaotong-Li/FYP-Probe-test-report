...
wr = struct( ...
    ...
    'close',          @CloseDoc,... 
    'ForceCloseDoc', @ForceCloseDoc...
    );

% ---------------------------------------
    function ForceCloseDoc(varargin)
       % ForceCloseDoc finds any instance of word and asks it to close
       try 
...
% ---------------------------------------
    ...
    function AddText(varargin)
        ...
        hdlActiveX.Selection.Font.ColorIndex = 'wdAuto'; % Set back to default color
